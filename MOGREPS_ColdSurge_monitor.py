...
def main_forecast(forecast_date_time):
    ...
    retrieve_mogreps.prepare_24hr_precip_accum_nonIrisWay(forecast_date_time)

    # 3. Process wind data, very straightforward
    retrieve_mogreps.prepare_24hr_wind_nonIrisWay(forecast_date_time, varname='x_wind', level=850)
    retrieve_mogreps.prepare_24hr_wind_nonIrisWay(forecast_date_time, varname='y_wind', level=850)
    ...
    # 8. Generate a html file
    # html_generator.write_html_page_instantaneous(forecast_date_time)
    html_generator.write_html_page_instantaneous(forecast_date_time, varname='relative_humidity')
